...
const operations = [
  ...
  },
  {
    ...
    color: 'bg-[#D4AF37]',
    content: `Many brilliant students with good characters are stifled in their education due to the lack of funds. The Costheta Educational Support fund helps 20 such students each year who are entering the universities to get a bit of help with a one-time gift for the extras needed for college life; food, accommodations, books, etc. We hope to see these numbers increase as we move forward in our commitment to promote our youth. In 2025 we had 22 students awarded with many receiving a gifts of laptop computers and more. Thus far 102 students have been awarded since its inception.`,
  },
  {
...
const imperativeQuestions = [
  'How do we resolve the lacuna in the 1992 Constitution of the Republic of Ghana on spiritual matters?',
  'Why did the Keta Municipal Assembly promulgate a bye-law prohibiting the act of invocation of the wrath of the gods and prescribed a penalty for anyone who invokes the wrath of the gods upon the other?',
  ...
  'Is there an alternative means that the same gods will prefer to save the lives of innocent persons some of whom had higher school/college/university education and could help develop the community and the nation at large?',
  'Are the practitioners and their gods aware of the constitutional provision on the subject matter? (Protection of Fundamental Human Rights and the Right to Life)',
  'What about the Keta Municipal Assembly\'s bye-law prohibiting the act of the invocation of the gods and its prescribed fine? Is this acceptable to the worshipers of the deities? Were they served copies of the bye-law or educated on the bye-law? Were they duly consulted prior to the enactment of the bye-law?',
  'Does this phenomenon have dire negative consequences on the society or are there advantages?',
  ...
  'Are the constitutional lawyers aware of the spiritual dimensions of judgment by worshipers of the deities?',
  'What is the correlation between the Keta Municipal Assembly\'s bye-law prohibiting the invocation of the wrath of the gods, its prescribed fine and that of the constitution of Ghana?',
  'Can this bye-law be acceptable at the law court if it had gone through the process of gazette?',
  'Why does the \'law\' refuse to frown on this practice despite its negative consequences on the society?',
  'What are the constitutional and or legal procedures in a matter like this?',
  'Were the worshipers of the deities served copies of the bye-law?',
  'What if the practitioners of the act refuse to abide by the provisions of the bye-law in this regard, what should the victims do or what happens?',
  'Is the Ghana Police Force given the right to protect the interest of the citizenry in light of this bye-law?',
  'Is this bye-law acceptable to the court vis a vis the constitutional and other legal provisions?',
  'Are Christians possible culprits in terms of invocation of the wrath of the gods?',
  'Do Christians, having accepted Jesus Christ as their Lord and personal Savior, resort to invocation of the wrath of the gods in times of provocation, stealing of their items by criminals, etc.?',
  'What if a Christian does invoke the wrath of the gods? Are there biblical sanctions to be imposed on such a person?',
  'Do Christians invoke the wrath of the almighty God on people? What is the correlation between the act of the invocation of the wrath of the gods and the Christians\' act of pleading the blood of Jesus?',
  'What is the Christians\' position on the provisions of the constitution of Ghana on the above subject matter?',
  'What is the Christian community doing to educate the public on the influx of false prophets?',
  'What are the consequences of false prophesies and falsifications of prophetic revelations?',
  'Do Moslems indulge themselves in the act of invocation of the wrath of the gods?',
  'What if a Moslem does?',
  'What is the Quran\'s prescribed penalty for the said person?',
  'What is the correlation between the Islamic laws, the Municipal bye-law and the Constitution?',
  'What is the relationship if any between customary law, traditional practices, Islamic law, Biblical and Christian injunctions and the Constitution and the laws of Ghana?',
];
...
const scopeOrganizations = [
  ...
  'The Ghana Education Service etc.',
];
      ...
      <section className="relative py-16 md:py-24 bg-[#0B3C5D] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-white/70 max-w-3xl mx-auto text-lg">
            A Non-Governmental Organization with a membership of over 48,743 as of March 2026, committed to promoting peace and reconciliation in our various communities.
          </p>
        </div>
      </section>
          ...
          <main className="flex-1 min-w-0 space-y-16">
            ...
            <motion.section id="concept" {...fadeInUp}>
              ...
              <div className="prose max-w-none">
                <p className="text-[#6B4F3A] leading-relaxed mb-4">
                  The Duamenefa Foundation is a Non-Governmental Organization, an (NGO) with a membership of over 48,743 (Forty-eight Thousand, Seven hundred-forty-three) as of 3rd March 2026, who have committed themselves to promoting peace and reconciliation in our various communities. Registration is ongoing. The word &ldquo;Duamenefa&rdquo; in the Ewe language literally means &ldquo;LET US CO-EXIST IN PEACE&rdquo;.
                </p>
                <p className="text-[#6B4F3A] leading-relaxed mb-4">
                  The name was birthed as a result of an ongoing intervention radio program which airs every Sunday 7:00pm &ndash; 10:00pm, Tuesday 11:00am &ndash; 2:00pm and Thursday 11:00am &ndash; 2:00pm on Fafaa 100.3 FM and is streamed live on Facebook pages: fafaa100.3fm and Duamenefa Foundation as well as Ketaman Emmanuel Evortepe FB pages. In addition, the programs are broadcast live on Justice FM 98.5 in Tamale, Swiss FM 93.7-Ho, and Messiah TV &ndash; Amos 17.
                </p>
                <p className="text-[#6B4F3A] leading-relaxed mb-4">
                  The &ldquo;Duamenefa&rdquo; program has succeeded in resolving over 726 hitherto antagonistic spiritual and diabolical conflicts ranging from:
                </p>
            ...
            <motion.section id="background" {...fadeInUp}>
              ...
              <div className="space-y-4">
                ...
                <p className="text-[#6B4F3A] leading-relaxed">
                  This belief has been entrenched in the community so much so that the Keta Municipal Assembly in the Volta Region of the Republic of Ghana was compelled to enact Bye-Law number 3.6 of 2006 under the title:
                </p>
                <Card className="border-l-4 border-l-[#4C9A2A] border-0 shadow-md">
                  <CardContent className="p-5">
                    ...
                    <p className="text-[#6B4F3A] text-sm">The above bye-law raises a lot of legal and social issues.</p>
                  </CardContent>
                </Card>
                <p className="text-[#6B4F3A] leading-relaxed">
                ...
                <p className="text-[#6B4F3A] leading-relaxed">
                  The Duamenefa Foundation has succeeded in resolving over 726 thorny disputes ranging from the invocation of the wrath of the gods, attempted usages of charms and other diabolical means to the detriment of innocent citizens, using innocent young children in servitude to the gods, resolution of false prophecies that set families apart. Hence, the Duamenefa Foundation&rsquo;s radio educational programs enjoy the patronage of the young and the old. The Duamenefa Foundation has over 48,743 certified members (volunteers) made up of chiefs, opinion leaders and the general public. There is daily registration of membership due to the high level of interest the program generates and it is estimated that membership will double in the next two years.
                </p>
              </div>
            </motion.section>
            ...
            <motion.section id="methodology" {...fadeInUp}>
              ...
              <div className="space-y-4">
                ...
                <p className="text-[#6B4F3A] leading-relaxed font-medium">The copies of petitions directed to the relevant stakeholders such as:</p>
                ...
                <p className="text-[#6B4F3A] leading-relaxed">
                  The Duamenefa Foundation delegates its journalist from Fafaa 100.3 FM to investigate the veracity of the petitions. This is followed by an on-air interrogation of the suspected perpetrators of the diabolical and spiritual crimes and the victims. There is also ongoing education on the matter through the participation of key resource persons from the statutory state organizations mentioned above.
                </p>
                <p className="text-[#6B4F3A] leading-relaxed">
                  In most cases, the spiritual attacks are reversed through community traditional arbitrations where all stakeholders gather to arbitrate and resolve the spiritual matters through the same processes that were used to inflict the harm and suffering on the victims. There is a live broadcast of the interventions of arbitrations on Fafaa 100.3 FM, Justice FM 98.5 Tamale, Swiss FM 93.7-Ho and Messiah TV- on Amos 17. Live streaming on Facebook pages: fafaa100.3fm and Duamenefa Foundation as well as Ketaman Emmanuel Evortepe and with live video coverage for all programs and during the arbitrations on Facebook live. All can be seen inside the posted stories on our websites covering the arbitration.
                </p>
                <p className="text-[#6B4F3A] leading-relaxed">
            ...
            <motion.section id="objectives" {...fadeInUp}>
              ...
              <div className="space-y-2 mb-8">
                {[
                  ...
                  'Seek the opinion of the Islamic Community on the provisions of the Quran on the aforementioned subject matter',
              ...
              <Card className="border-l-4 border-l-[#0B3C5D] border-0 shadow-md">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <HelpCircle className="h-5 w-5 text-[#0B3C5D]" />
                    <h3 className="font-heading font-bold text-lg text-[#0B3C5D]">
                      Imperative Questions
                    </h3>
                  </div>
                  <p className="text-[#6B4F3A] leading-relaxed mb-4 text-sm">
                  ...
                  <div className="space-y-2.5">
                    {imperativeQuestions.map((q, i) => (
                      <div key={i} className="flex items-start gap-3">
                        <span className="text-[#D4AF37] font-bold text-xs shrink-0 mt-0.5">{i + 1}.</span>
                        <p className="text-[#6B4F3A] text-sm leading-relaxed">{q}</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
                ...
                {operations.map((op, i) => (
                  <Card key={i} className="border-0 shadow-md hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      ...
                      {op.subtitle && (
                        <p className="text-[#D4AF37] text-sm font-medium mb-3 ml-[52px]">{op.subtitle}</p>
                      )}
                      <p className="text-[#6B4F3A] leading-relaxed text-sm ml-0">{op.content}</p>
                      {op.content2 && (
